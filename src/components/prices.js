     ...
     <div className="prices">
        ...
        <div className="pricescol">
         ...
         <div className="nation">
            <p><strong>United Nations Good For All Winner (2021)</strong><br/>The jury selected Fresh.Land as one of the 50 winners out of 2,000 finalists based on our contribution to a better food system.</p>
         </div>
        </div>
      <hr className="hr"></hr>
        <div className="pricescol">
        ...
        <div className="pricescol">
         <div>
         <img src={climate} alt="climate" className="img-fluid juryimg"></img>
         </div>
         <div className="nation">
            <p><strong>United Nations Good For All Winner (2021)</strong><br/>The jury selected Fresh.Land as one of the 50 winners out of 2,000 finalists based on our contribution to a better food system.</p>
         </div>
        ...
        <hr className="hr"></hr>
         <div className="politiken">
           <div>
            <h1 className="fs-3 text-decoration-underline text-dark link-underline-danger">POLITIKEN</h1>
