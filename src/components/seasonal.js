        ...
        <div>
          <div className=" fruitsitems delicious border rounded">
            <div className="text-center text-white">
              ...
              <p className="px-5">
                When you sign up for one or more of our VIP lists, you get
                exclusive news about the season's new products. Best of all, you
                get the opportunity to order the new fruits and vegetables, 24
                hours before everyone else - and it's even completely free to be
                a member!
              </p>
            </div>
            ...
            <div className="allproductsbtn ">
              <button
                type="button"
                className="btn seebtn  fw-bolder bg-white text-secondary"
              >
                SEE ALL OUR VIP LIST
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-sm-6">
                ...
                <p>
                  We can all help make a difference and future-proof our food
                  system by buying fruit and vegetables directly from the
                  farmer.
                </p>
                <p>
                  Thank you to Tomorrow for focusing on the solutions that will
                  future-proof our society and help us to stand stronger in the
