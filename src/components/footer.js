        ...
        <div class="footer container-fluid mt-5">
          <div className="px-5">
            <div className="row listsection">
                ...
                <div className="col-sm-3">
                    <button className="btn change"><span className="country">Change country</span><span><i class="bi bi-globe"></i></span></button>
                </div>
            </div>
          </div>
          <hr></hr>
          <div className="footericon py-5">
            ...
            <div>
                <ul>
                    <li className="nav-link"> <i class="bi bi-facebook"></i></li>
               
           <li className="nav-link"><i class="bi bi-twitter"></i></li> 
           <li className="nav-link"><i class="bi bi-instagram"></i></li> 
           <li className="nav-link"><i class="bi bi-youtube"></i></li> 
          <li className="nav-link"><i class="bi bi-linkedin"></i></li>  
                </ul>
            ...
            <div className="text-center">
                <p>Fresh.Land © 2022<br/>
                CVR 43007106<br/>
                info@fresh.land|53 79 07 07<br/>
               Indiakaj 20, 2100 Copenhagen Ø 🇩🇰</p>
            </div>
          </div>
        </div>
        </>
